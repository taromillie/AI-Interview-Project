...
.rc-ico.purple { background: linear-gradient(135deg, #6b8bff, #8b6bff); }
.rc-ico.pink { background: linear-gradient(135deg, #ff6b9d, #e04b82); }
.transfer-item,
.project-item {
  background: rgba(255, 255, 255, 0.04);
  border: 1px solid var(--app-border);
}
.transfer-skill { color: var(--app-cyan); }
.proj-tip {
  color: var(--app-amber);
