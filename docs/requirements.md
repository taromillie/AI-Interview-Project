...
> **v1.1 修订说明**：新增岗位广场（实时岗位招聘入口）、面试官角色选择、面试难度选择三大功能模块；明确全站采用「向导式分步交互」与「极简导航」的 UI/UX 设计基线（对齐 Lollipop 类产品的清爽视觉风格）。
...
| **C（可以有）** | 过渡项目推荐、offer 对比、情绪分析深化、**我的岗位（FR-H-06）**、**面试官评语复盘（FR-I-05）** | Phase 4 |
