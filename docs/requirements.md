...
| 优先级 | 需求范围 | 对应阶段 |
|---|---|---|
| **M（必须有）** | 模块 A（登录/Provider 配置）、模块 B 全部、模块 C 文字面试核心链路（FR-C-01/04/05/07/08/09）、模块 D 复盘（FR-D-01/02）、模块 G 题库核心（FR-G-01/02） | Phase 1 MVP |
| **S（应该有）** | 语音面试、视频面试、备战日历、真实面试复盘、能力画像/成长追踪、转行诊断、谈薪模拟、公共题库、知识覆盖 | Phase 2–3 |
| **C（可以有）** | 过渡项目推荐、offer 对比、情绪分析深化 | Phase 4 |
| **W（暂不需要）** | 多租户、移动端 App、支付计费 | 后续迭代 |
...
| 阶段 | 时间窗口 | 里程碑 | 交付范围 |
|---|---|---|---|
| **P1 · MVP 闭环** | 2026-08-27 ~ 08-28 | 注册登录 + 简历×JD 诊断 + 文字模拟面试 + 复盘报告跑通 | 模块 A/B 全部、C 文字链路（FR-C-01/04/05/07/08/09）、D（FR-D-01/02）、G（FR-G-01/02） |
| **P2 · 差异化深化** | 2026-08-29 ~ 08-30 | 语音面试、转行诊断、谈薪模拟、能力画像可用 | FR-C-02/06、FR-D-04、模块 E、F（FR-F-01/02） |
| **P3 · 体验完善** | 2026-08-31 ~ 09-01 | 视频面试、真实面试复盘、成长趋势、公共题库 | FR-C-03、FR-D-03/05/06、FR-G-03/04/05、FR-B-06 |
